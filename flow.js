...
class Flow {
  constructor(setState, history, path, prevSteps, setPrevSteps, repairLocationFlowNextSteps, repairProblemFlowNextSteps, repairDescriptionFlowNextSteps) {
    ...
    this.flow = {
      ...
      'repair-location': { prevStep: 'address', nextStep: repairLocationFlowNextSteps},
      /*'repair-location': { prevStep: 'address', nextStep: 'repair-problems'},*/
      ...
      'repair-problems': { prevStep: 'repair-location', nextStep: repairProblemFlowNextSteps},
      // 'repair-problems': { prevStep: 'repair-location', nextStep: [
      //   {condition: 'cupboards', nextStep: 'repair-problem-best-description'},
      //   {condition: 'bath', nextStep: 'repair-problem-best-description'},
      // ]},

      // 'repair-problem-best-description': {prevStep: 'repair-problems', nextStep: 'repair-description'},
      'repair-problem-best-description': {prevStep: 'repair-problems', nextStep: repairDescriptionFlowNextSteps},
    ...
    if (nextFlowStep) {
      if (Array.isArray(nextFlowStep)) {
        ...
        if(typeof value === 'object'){
          console.log(`nextFlowStep is ${JSON.stringify(nextFlowStep)}`)
          console.log(`value.value is ${JSON.stringify(value.value)}`)
